...
const faqs = [
  {
    q: "What is FineTune Physics?",
    a: "FineTune Physics is a Chrome extension that lets you interactively adjust the fundamental constants of the universe — gravity (G), the speed of light (c), and Planck's reduced constant (ℏ) — and watch atoms, stars, and cosmic history respond in real time.",
  },
  {
    q: "Is it really free?",
    a: "Yes — completely free to install from the Chrome Web Store. No account, no subscription, no hidden costs. Just install and start bending reality.",
  },
  {
    q: "What browsers are supported?",
    a: "FineTune Physics is available as a Chrome extension. It works on any Chromium-based browser including Chrome, Brave, Edge, and Opera.",
  },
  {
    q: "How do I switch between Beginner and Expert mode?",
    a: "Inside the extension, there's a mode toggle in the top bar. Beginner mode shows plain-language explanations and guided prompts. Expert mode reveals the underlying equations and precise numeric readouts.",
  },
  {
    q: "Can I share my universe configuration with others?",
    a: "Absolutely. The Share Links feature generates a unique URL encoding your exact constant values. Anyone with the link can open the same universe configuration instantly.",
  },
  {
    q: "Why does my universe collapse when I increase G?",
    a: "Higher gravitational constant makes stellar processes run much faster — stars burn their fuel in fractions of the normal time, collapse to black holes, and the gravitational pressure on atoms becomes unsustainable. The consequence alert will tell you exactly what broke.",
  },
  {
    q: "What are the Challenges?",
    a: "Challenges are tiered objectives that ask you to achieve specific universe states — like maintaining a habitable window for 5 billion simulated years, or creating a stable neutron star. They teach stability thresholds through direct experimentation.",
  },
  {
    q: "I found a bug — how do I report it?",
    a: "Use the contact form on this page or reach out via the Chrome Web Store review page. Please include your browser version and a description of what happened.",
  },
];
...
await emailjs.send(
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <section className="relative min-h-[45vh] flex items-center overflow-hidden bg-background pt-20">
        ...
        <div
          className="absolute top-1/3 right-1/4 w-2 h-2 bg-primary/60 rounded-full pointer-events-none"
          style={{ animation: "floatA 8s ease-in-out infinite" }}
        />
        <div
          className="absolute bottom-1/4 left-1/4 w-1.5 h-1.5 bg-accent/60 rounded-full pointer-events-none"
          style={{ animation: "floatB 6s ease-in-out 2s infinite" }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 w-full">
          ...
          >
            ...
            <p className="text-muted-foreground text-xl leading-relaxed">
              Questions about the app, bug reports, or just want to share your wildest universe — I'd love to hear from you.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {[
              {
                icon: BookOpen,
                title: "FAQ",
                desc: "Browse common questions about features, constants, and how the simulation works.",
                action: "Jump to FAQ",
                scrollId: "faq",
              },
              {
                icon: Mail,
                title: "Email Support",
                desc: "Send us a message using the contact form below. We respond within 72 hours.",
                action: "Contact us",
                scrollId: "contact",
              },
              {
                icon: MessageCircle,
                title: "Chrome Reviews",
                desc: "Leave feedback directly on the Chrome Web Store — we read every review.",
  ...
  Your message was successfully sent. A confirmation email has also been sent to you — please check your spam or promotions folder if you do not see it. I will do my best to respond within 72 hours.
</p>
              </div>
            ) : (
              <form
                onSubmit={handleSubmit}
                className="bg-card border border-border/60 rounded-3xl p-8 shadow-2xl space-y-5"
              >
                <div>
